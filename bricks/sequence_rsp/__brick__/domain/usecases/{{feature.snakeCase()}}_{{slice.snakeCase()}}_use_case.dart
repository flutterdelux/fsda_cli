...
class {{feature.pascalCase()}}{{slice.pascalCase()}}UseCase
    extends StreamUseCase<{{feature.pascalCase()}}Entity, {{feature.pascalCase()}}{{slice.pascalCase()}}Param> {
  ...
  @override
  StreamResult<{{feature.pascalCase()}}Entity> call({{feature.pascalCase()}}{{slice.pascalCase()}}Param param) {
