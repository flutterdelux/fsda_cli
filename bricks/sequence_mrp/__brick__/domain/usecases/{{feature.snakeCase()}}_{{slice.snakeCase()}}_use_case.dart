...
class {{feature.pascalCase()}}{{slice.pascalCase()}}UseCase extends UseCase<{{feature.pascalCase()}}Entity, {{feature.pascalCase()}}{{slice.pascalCase()}}Param> {
  ...
  @override
  AsyncResult<{{feature.pascalCase()}}Entity> call({{feature.pascalCase()}}{{slice.pascalCase()}}Param param) {
