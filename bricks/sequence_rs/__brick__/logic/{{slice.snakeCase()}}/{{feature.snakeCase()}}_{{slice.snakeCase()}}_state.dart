...
sealed class {{feature.pascalCase()}}{{slice.pascalCase()}}State with _${{feature.pascalCase()}}{{slice.pascalCase()}}State {
  ...
  const factory {{feature.pascalCase()}}{{slice.pascalCase()}}State.loaded({
    required List<{{feature.pascalCase()}}Entity> data,
  }) = _Loaded;
  const factory {{feature.pascalCase()}}{{slice.pascalCase()}}State.failure({required Failure failure}) =
      _Failure;
}
