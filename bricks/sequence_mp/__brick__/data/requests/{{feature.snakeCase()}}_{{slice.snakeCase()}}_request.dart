...
abstract class {{feature.pascalCase()}}{{slice.pascalCase()}}Request with _${{feature.pascalCase()}}{{slice.pascalCase()}}Request {
  ...
  const factory {{feature.pascalCase()}}{{slice.pascalCase()}}Request({required int id}) = _{{feature.pascalCase()}}{{slice.pascalCase()}}Request;

  factory {{feature.pascalCase()}}{{slice.pascalCase()}}Request.fromJson(Map<String, dynamic> json) => _${{feature.pascalCase()}}{{slice.pascalCase()}}RequestFromJson(json);

  factory {{feature.pascalCase()}}{{slice.pascalCase()}}Request.fromParam({{feature.pascalCase()}}{{slice.pascalCase()}}Param param) {
    return {{feature.pascalCase()}}{{slice.pascalCase()}}Request(id: param.id);
  }
}
