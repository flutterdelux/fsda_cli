...
abstract class {{feature.pascalCase()}}{{slice.pascalCase()}}Response with _${{feature.pascalCase()}}{{slice.pascalCase()}}Response {
  const factory {{feature.pascalCase()}}{{slice.pascalCase()}}Response({
    ...
    @JsonKey(fromJson: _{{feature.camelCase()}}ListFromJson) List<{{feature.pascalCase()}}Dto>? data,
    String? code,
    List<String>? errors,
...
List<{{feature.pascalCase()}}Dto>? _{{feature.camelCase()}}ListFromJson(Object? json) {
  if (json is List) {
    return json
