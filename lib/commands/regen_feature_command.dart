...
class RegenFeatureCommand extends Command<void> {
  ...
  RegenFeatureCommand({
    ...
    final datasourceHelp =
        'Datasource baseline scope. Supported: ${DataSourceMode.values.map((mode) => mode.value).join(', ')}';
  ...
  @override
  final String name = 'regen-feature';

  @override
  final String description =
      'Regenerate missing baseline files for an existing feature without overwriting existing files.';
  ...
  Future<void> run() async {
    ...
    await featureGenerator.regenerate((
      feature: feature,
      module: module,
      dataSourceMode: dataSourceMode,
    ));
